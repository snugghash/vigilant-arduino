...
void nRF_receive(void) {
  ...
  if ( radio.available() ) {
    ...
    // Check for specific messages, and act upon them i.e. buzzer
    if(!strcmp(RecvPayload,"1")) {
      // Buzzer activation
      //Serial.println()
    }
    else if(!strcmp(RecvPayload,"2")) {
      
    }
    else if(!strcmp(RecvPayload,"3")) {
      
    }
    else if(!strcmp(RecvPayload,"4")) {
      
    }
    else if(!strcmp(RecvPayload,"5")) {
      
    }
    else if(!strcmp(RecvPayload,"6")) {
